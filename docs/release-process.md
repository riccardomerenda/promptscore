...
- The same release workflow validates the generated `changeset-release/main` branch, merges the `Version Packages` PR automatically, deletes the release branch, publishes the merged version, and creates the GitHub tag/release.
